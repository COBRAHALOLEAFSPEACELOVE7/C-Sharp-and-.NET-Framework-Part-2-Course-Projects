    ...
    public class InsureeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,EmailAddress,DateOfBirth,CarYear,CarMake,CarModel,DUI,SpeedingTickets,CoverageType,")] Insuree insuree)
        {
            if (ModelState.IsValid)
            {
                ...
                Quote = Quote + 50;
                if (DateOfBirth.Year <= 2005)
                    Quote = Quote + 100;
                else if (DateOfBirth.Year >= 2004 && DateOfBirth.Year <= 1998)
                    Quote = Quote + 50;
                ...
                if (CarMake == "Porsche")
                    ...
                    Quote = Quote + 50;
                // Dont know how to write i. Add $10 to the monthly total for every speeding ticket the user has.
                if (DUI == true)
                    Quote = Quote + 25 %;
                else Quote = Quote;
